...
%\sbox{\mywatermark}{\includegraphics[keepaspectratio,width=5.1cm]{my_watermark}}
\sbox{\mywatermark}{\includegraphics[keepaspectratio,width=5.1cm]{images/UCP_Logo.jpg}}
