...
\renewcommand{\baselinestretch}{0.8}  % 論文行距設定為 1
...
\begin{tabular}{%
	m{3cm}m{0.1cm}m{2cm}m{0.1cm}m{11cm}m{1cm}m{2.5cm}m{0.1cm}m{1.5cm}}
\fontsize{8}{6}\selectfont\univCname
\newline
\deptCname & & 
碩士論文 & &
{\fontsize{14}{12}\selectfont\cTitle} & &
{\fontsize{14}{14}\myCname 撰} & &
\rotatebox{90}{\cYear} \rotatebox{90}{\hspace{0.45em}\cMonth}
\end{tabular}
}
\end{center}
