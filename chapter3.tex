...
%\item加入不同的觀點去探討:
  ...
  %由於時代的進步與環境的變遷,網路購物已經成為一個飛快成長的市場,
%然而國內對於網路購物之消費者的研究多數仍以滿意度、忠誠度、購買意願為
%主要的研究目的,是以能夠加入更多不同的觀點來探討。如網路消費行為的決策流程....等
%\item樣本收集:

  %在樣本來源方面,可以將延伸至各年齡層並擴及整個台灣或者增加有效問
%卷數即可提升研究之可信度。
%\item研究角度:

  %本研究僅針對顧客角度的個人樣本進行調查,建議後續研究者,可以考量加入購物網站業者為調查的問卷作為對照樣本,以比對購物網站業者與顧客兩者之間對於轉換成本及品牌知名度的差異為何,使得分析為客觀,更具實用價值。
%\end{enumerate}
